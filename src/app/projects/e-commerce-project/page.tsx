      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-3xl">
            An end-to-end e-commerce solution engineered with modern
            technologies and a scalable backend architecture, focused on
            delivering a flawless user experience and high performance.
          </p>
        </div>
            ...
            <section>
              ...
              <ul className="space-y-4 text-zinc-600 dark:text-zinc-400 text-base md:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  <span>Custom JWT-based Authentication System</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-emerald-500 shrink-0"
                  ...
                  <span>Global State Management for Shopping Cart</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-emerald-500 shrink-0"
                  ...
                  <span>Dynamic Product Filtering and Search</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-emerald-500 shrink-0"
                  ...
                  <span>Optimized Image Rendering & SEO Compliance</span>
                </li>
              </ul>
            </section>
          </div>
